...
void Renderer::LoadMouseCursor()
{
	HRESULT hres;
  hres = pD3DDevice->CreateOffscreenPlainSurface(
    16, 16, D3DFMT_A8R8G8B8, D3DPOOL_SYSTEMMEM, &m_pCursorBitmap, NULL);
  hres = D3DXLoadSurfaceFromFile(m_pCursorBitmap, NULL, NULL, //copy to surface
    "cursor.png", NULL, D3DX_DEFAULT, 0, NULL);
}

void Renderer::SetMouseCursor()
{
	HRESULT hres = pD3DDevice->SetCursorProperties(7, 0, m_pCursorBitmap);
	pD3DDevice->ShowCursor(TRUE);
	/*pD3DDevice->SetCursorPosition(110, 110, 0); */
}
